        ...
        <div class="container">
            ...
            <nav class="site-header-nav" role="navigation">
              <?php if(empty($_SESSION['username'])):?>
               ...
               <?php else: ?>
                <a href="javascript:;" style="color:yellow;">欢迎:<?=$_SESSION['username'];?></a>
                <?php if(!empty($_SESSION['udertppe']) && $_SESSION['udertppe'] == 1):?>
                <a href="index.php?m=admin&c=admin&a=admin" style="color:yellow;">文章管理</a>
                 <?php endif;?>
                <a href="index.php?m=index&c=user&a=logout" style="color:yellow;">退出</a>
                
                <?php endif;?>
                <a href="javascript:;" style="color:yellow;"></a>
...
<section class="container content">
                ...
                <?php foreach($data as $blog):?>
                     <li class="repo-list-item">
                        ...
                        <p class="repo-list-description">
                            <a href="index.php?m=index&c=index&a=blog&bid=<?=$blog['bid'];?>">
                            <?=$blog['title'];?></a>
                        </p>
    ...
    <div class="pagination text-align">
      <div class="btn-group">
            ...
            <!-- <button disabled="disabled" href="javascript:;" class="btn btn-outline">首页</button> -->
        
        
            <a href="<?=$date['first'];?>" class=" btn btn-outline">首页</a>
        
        
          
              <a href="<?=$date['pre'];?>" class="btn btn-outline">上一页</a>
          
        
          
              <a href="<?=$date['next'];?>" class="btn btn-outline">下一页</a>
          	  <a href="<?=$date['last'];?>" class="btn btn-outline">尾页</a>
